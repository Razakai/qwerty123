...
class Database():
    ...
    def createTables(self):
        ...
        cursor.execute("create table metrics (id integer PRIMARY KEY AUTOINCREMENT, sensorId int not null, temperature float not null, humidity float not null, timestamp DATE, FOREIGN KEY (sensorId) REFERENCES sensor(id))")
        self.db.commit()
